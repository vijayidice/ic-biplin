...
from incentive_slab
where incentive_slab.divisionid = 10
...
where glen_budget_summaryP.divisionid = 10
...
and glen_budget_summaryP.incentive_group = 'PEG NT'
having ind1 = 1 ) p1
...
and glen_budget_summaryP.fyear = incentive_summaryP.fyear
and glen_budget_summaryP.incentive_group = incentive_summaryP.noofbrand_bud
and glen_budget_summaryP.incentive_group in('EPICTAL','RECITA','NERVON FORTE','DIVALRATE ER','PARI COMBO')
having ind1 = 1 ) p1
set glen_budget_summaryP.ach_val_fr = p1.ach_val_fr,  glen_budget_summaryP.ach_val_to = p1.ach_val_to 
where glen_budget_summaryP.divisionid = 10
and glen_budget_summaryP.territory_type = 'metro/non-metro' 
...
"update incentive_slab set pearn_pcent = 65.00, exp_pcent = 40, esv_pcent = 92.98
where fyear = '2019-20'
and incentive_type = 'quarterly'
and group_code = 5
and divisionid = 10";
...
and incentive_summaryP.divisionid = 10";
?>