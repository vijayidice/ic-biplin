...
<div class="user-dashboard">
    <h2>Reports / Annual Achievement Guidance Report</h2>
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="sales admin-page">
                <div class="panel-group" id="accordion">
                    <form action="{{ route('annual-achievement-guidance-report-generate') }}" method="post" id="incetiveConfiguratorFrm">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group text-center">
                                            <button type="submit" class="btn btn-success" id="generate"><i class="fa fa-file" aria-hidden="true"></i> Generate</button>
