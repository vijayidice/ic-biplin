...
where glen_budget_summary.divisionid = 10
...
"update incentive_slab set pearn_pcent = 40.00 where fyear = '2019-20' and incentive_type = 'quarterly' and divisionid = 10";
...
where incentive_summary.divisionid = 10
