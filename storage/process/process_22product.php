...
incentive_slab.noofbrand_bud, incentive_slab.ach_val_fr, incentive_slab.ach_val_to,incentive_slab.app_amount
from incentive_slab
where incentive_slab.divisionid = 22
...
order by 3) p1
set incentive_summaryP.incentive_pcent1 = p1.app_amount
...
where glen_budget_summaryP.divisionid = 22
...
and incentive_summaryP.divisionid = 22";
?>