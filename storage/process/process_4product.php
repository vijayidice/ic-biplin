<?php
"update incentive_summaryP, (select incentive_slab.divisionid, incentive_slab.profileid, incentive_slab.territory_type, incentive_slab.incentive_type, incentive_slab.fyear,
incentive_slab.noofbrand_bud, incentive_slab.ach_val_fr, incentive_slab.ach_val_to,incentive_slab.app_pcent
from incentive_slab
where incentive_slab.divisionid = 4 
...
where glen_budget_summaryP.divisionid = 4
...
and glen_budget_summaryP.incentive_group in ('azr','calten d')
having ind1 = 1 ) p1
...
glen_budget_summaryP.area_code,glen_budget_summaryP.sap_territory_code,glen_budget_summaryP.incentive_group,
glen_budget_summaryP.profileid,
glen_budget_summaryP.fyear,glen_budget_summaryP.territory_type,glen_budget_summaryP.pmpt_value,
incentive_summaryP.ach_val_fr, incentive_summaryP.ach_val_to,
if(glen_budget_summaryP.pmpt_value > incentive_summaryP.ach_val_fr and glen_budget_summaryP.pmpt_value <= incentive_summaryP.ach_val_to ,1,0) as ind1
from glen_budget_summaryP ,incentive_summaryP
where glen_budget_summaryP.divisionid = 4
and glen_budget_summaryP.territory_type = 'metro/non-metro' 
and glen_budget_summaryP.profileid = 5
...
and glen_budget_summaryP.fyear = incentive_summaryP.fyear
and glen_budget_summaryP.incentive_group = incentive_summaryP.noofbrand_bud
and glen_budget_summaryP.incentive_group in ('adalipca','apraize','ebuxo','etova','lefno','rituxipca','saaz','tacva','terifort')
having ind1 = 1 ) p1
set glen_budget_summaryP.ach_val_fr = p1.ach_val_fr,  glen_budget_summaryP.ach_val_to = p1.ach_val_to 
where glen_budget_summaryP.divisionid = 4
and glen_budget_summaryP.territory_type = 'metro/non-metro' 
...
and glen_budget_summaryP.fyear = incentive_summaryP.fyear
and glen_budget_summaryP.incentive_group = incentive_summaryP.noofbrand_bud
and incentive_summaryP.ach_val_fr = 0
and glen_budget_summaryP.ach_val_to = 0 having ind1  = 1) p1
set glen_budget_summaryP.ach_val_fr = p1.ach_val_fr,  glen_budget_summaryP.ach_val_to = p1.ach_val_to 
where glen_budget_summaryP.divisionid = 4
and glen_budget_summaryP.territory_type = 'metro/non-metro' 
and glen_budget_summaryP.profileid = 5
...
and glen_budget_summaryP.sap_territory_code = p1.sap_territory_code
and glen_budget_summaryP.incentive_group  = p1.incentive_group 
and glen_budget_summaryP.ach_val_fr = 0
and glen_budget_summaryP.ach_val_to = 0";
