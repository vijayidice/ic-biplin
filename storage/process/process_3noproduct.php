...
and incentive_slab.noofbrand_bud in ('brand2','brand3')
...
and incentive_slab.txn_no = 1
and incentive_slab.fyear = '2019-20'
and incentive_slab.noofbrand_bud in ('brand1')
order by 3) p1
...
and incentive_slab.txn_no = 1
and incentive_slab.fyear = '2019-20'
and incentive_slab.noofbrand_bud in ('brand7_8','brand8')
order by 3) p1
...
and incentive_slab.incentive_type = 'quarterly'
and incentive_slab.group_code in (3)
and incentive_slab.txn_no = 1
and incentive_slab.fyear = '2019-20'
and incentive_slab.noofbrand_bud in ('brand2','brand3')
order by 3) p1
...
and incentive_summary.profileid = p1.profileid
and incentive_summary.territory_type = p1.territory_type
and incentive_summary.incentive_type = p1.incentive_type
and incentive_summary.ach_val_fr = p1.ach_val_fr
and incentive_summary.ach_val_to = p1.ach_val_to
and incentive_summary.fyear = '2019-20'";
...
and incentive_slab.profileid = 5
and incentive_slab.territory_type = 'non-metro'
and incentive_slab.incentive_type = 'anual_ach'
and incentive_slab.fyear = '2019-20'
and incentive_slab.txn_no = 1
...
where glen_budget_summary.divisionid = 3 
...
"update incentive_slab set pearn_pcent = 40.00 where fyear = '2019-20' and incentive_type = 'quarterly' and group_code = 0";
...
and incentive_slab.incentive_type = 'quarterly'
and incentive_slab.fyear = '2019-20'
and incentive_slab.group_code = 3
and incentive_slab.txn_no = 1
and noofbrand_bud = 'brand1'
order by ach_val_fr,ach_val_to) p1
set incentive_summary.prospective_earn = round(incentive_summary.tot_psr * p1.pearn_pcent/ 100,0) + p1.pearn_factor
...
total_incentive = qtr_incentive_total + annual_incentive, yearly_sale = 4 * tot_qtr_sale, tot_incentive_pcent = round(total_incentive/1000/yearly_sale,2),
...
where divisionid = 3
and profileid = 5 and fyear = '2019-20'";
?>