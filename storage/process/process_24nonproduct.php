...
from incentive_slab
where incentive_slab.divisionid = 24
and incentive_slab.profileid = 5
and incentive_slab.territory_type = 'non-metro'
and incentive_slab.txn_no = 1
and incentive_slab.noofbrand_bud in ('brand2')
...
and incentive_slab.territory_type = 'non-metro'
and incentive_slab.txn_no = 1
and incentive_slab.noofbrand_bud in ('brand3_5')
and incentive_slab.fyear = '2019-20'
order by 3) p1
set incentive_summary.incentive_pcent2 = p1.app_pcent
where incentive_summary.divisionid = p1.divisionid
and incentive_summary.profileid = p1.profileid
and incentive_summary.territory_type = p1.territory_type
and incentive_summary.ach_val_fr = p1.ach_val_fr
...
and incentive_slab.territory_type = 'non-metro'
and incentive_slab.txn_no = 1
and incentive_slab.noofbrand_bud in ('brand6')
and incentive_slab.fyear = '2019-20'
order by 3) p1
set incentive_summary.incentive_pcent3 = p1.app_pcent
where incentive_summary.divisionid = p1.divisionid
and incentive_summary.profileid = p1.profileid
and incentive_summary.territory_type = p1.territory_type
and incentive_summary.ach_val_fr = p1.ach_val_fr
...
where incentive_slab.divisionid = 24
and incentive_slab.profileid = 5
and incentive_slab.territory_type = 'metro'
and incentive_slab.txn_no = 1
and incentive_slab.noofbrand_bud in ('brand3')
and incentive_slab.fyear = '2019-20'
order by 3) p1
set incentive_summary.incentive_pcent1 = p1.app_pcent
where incentive_summary.divisionid = p1.divisionid
...
and incentive_slab.territory_type = 'metro'
and incentive_slab.txn_no = 1
and incentive_slab.noofbrand_bud in ('brand4_7')
and incentive_slab.fyear = '2019-20'
order by 3) p1
set incentive_summary.incentive_pcent2 = p1.app_pcent
where incentive_summary.divisionid = p1.divisionid
...
and incentive_slab.territory_type = 'metro'
and incentive_slab.txn_no = 1
and incentive_slab.noofbrand_bud in ('brand8')
and incentive_slab.fyear = '2019-20'
order by 3) p1
set incentive_summary.incentive_pcent3 = p1.app_pcent
where incentive_summary.divisionid = p1.divisionid
...
set incentive_summary.annual_incentive = p1.app_amount
where incentive_summary.divisionid = p1.divisionid
and incentive_summary.profileid = p1.profileid
and incentive_summary.territory_type = p1.territory_type
and incentive_summary.ach_val_fr = p1.ach_val_fr
...
where glen_budget_summary.divisionid = 24
and glen_budget_summary.territory_type = 'non-metro'
...
from glen_budget_summary ,incentive_summary
where glen_budget_summary.divisionid = 24
and glen_budget_summary.territory_type = 'metro'
and glen_budget_summary.profileid = 5
and glen_budget_summary.fyear = '2019-20'
and glen_budget_summary.divisionid = incentive_summary.divisionid
and glen_budget_summary.territory_type = incentive_summary.territory_type
...
"update incentive_slab set pearn_pcent = 40.00 where fyear = '2019-20' and incentive_type = 'quarterly' and divisionid = 24";
...
"update incentive_summary set brand1_pcent = 20, brand2_pcent = 30, brand3_pcent = 50 
where incentive_summary.divisionid = 24
...
qtr_incentive_total = round(qtr_incentive1 * brand1_pcent/100 + qtr_incentive2 * brand2_pcent/100 + qtr_incentive3 * brand3_pcent/100 ,0) * 4,
