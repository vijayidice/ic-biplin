...
<div class="user-dashboard">
    <h2>Prospective Earning Factor</h2>
    <div class="row">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group text-center">
                                                <a class="collapsed btn btn-page" role="button" data-toggle="collapse" data-parent="#incetiveConfiguratorFrm" id="step1" href="#collapseThree">Next <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                                            </div>
                                    </div>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        $("#step1").on("click", function()
        {
            ...
            var inc_confi_type = 'prospective';
            ...
            if(division == '14')
            {
                var intima_type = $('input[name=territory]:checked').val();
            }
