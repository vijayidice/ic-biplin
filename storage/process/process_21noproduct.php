...
from incentive_slab
where incentive_slab.divisionid = 21
...
if(glen_budget_summary.pmpt_units > incentive_summary.ach_val_fr and glen_budget_summary.pmpt_units <= incentive_summary.ach_val_to ,1,0) as ind1
from glen_budget_summary ,incentive_summary
where glen_budget_summary.divisionid = 21
...
and incentive_summary.fyear = '2019-20'";
 ...
 "update incentive_slab set pearn_pcent = 40.00 where fyear = '2019-20' and incentive_type = 'quarterly' and divisionid = 21";
...
where incentive_summary.divisionid = 21
