...
from incentive_slab
where incentive_slab.divisionid = 15
...
where glen_budget_summary.divisionid = 15
...
"update incentive_slab set pearn_pcent = 40.00 where fyear = '2019-20' and incentive_type = 'quarterly' and divisionid = 15";
...
where incentive_summary.divisionid = 15
